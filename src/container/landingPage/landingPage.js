        ...
        return (
            <>
                <div className="containerBg">
                    <div className="ml-24 mt-8">A L - Q U R ' A N</div>
                    <div className="float-right search -mt-8 mr-2">
                        <svg className="inline-block" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M18.4288 18.4288L25 25" stroke="#116A55" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round"/>
                        </svg>
                        <input type="text" className="w-2/4 ml-5 text-base" placeholder="Find Surah..."></input>
                    </div>

                    <div className="mt-24 ml-16">
                        <div className="text-5xl font-extrabold title">Let’s Read Al-Qur’an</div>
                        <div className="ml-2 mw-2/4">
                            <div>QS : Al-Ahzab : 34</div>
                            <div className="w-2/4 main-banner">
                                ...
                                <button className="float-right mt-5 mr-10 button-landing">GET STARTED</button>
                            </div>
